...
# To create a VPC network or legacy network resource on GCP
...
# To create a subnet resource on GCP
...
# To create a route resource on GCP
...
# To create a router resource on GCP
...
# To create a NAT resource on GCP
